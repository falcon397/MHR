pipeline {
    ...
    stages {
        ...
        stage('Build + SonarQube analysis') {
            steps {
                withSonarQubeEnv('Huckshome SonarQube Server') {
                    ...
                    bat '"C:\\Program Files (x86)\\MSBuild\\14.0\\Bin\\MSBuild.exe" MHR.sln /t:Rebuild'
        ...
        stage('Deploy') {
            steps {
                bat '"C:\\Program Files (x86)\\MSBuild\\14.0\\Bin\\MSBuild" "MHR/MHR.csproj" /T:Rebuild /p:Configuration=Release /p:OutputPath="obj\\RELEASE" /p:DeployIisAppPath="/Default Web Site/MHR" /p:VisualStudioVersion=14.0'
